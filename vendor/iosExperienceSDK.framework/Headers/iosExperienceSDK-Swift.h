...
SWIFT_CLASS("_TtC16iosExperienceSDK26RSCodeReaderViewController")
@interface RSCodeReaderViewController : UIViewController <AVCaptureMetadataOutputObjectsDelegate>
@property (nonatomic, strong) AVCaptureDevice * _Nullable device SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.device' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, strong) AVCaptureMetadataOutput * _Nonnull output SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.output' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, strong) AVCaptureSession * _Nonnull session SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.session' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, strong) RSFocusMarkLayer * _Nonnull focusMarkLayer SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.focusMarkLayer' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, strong) RSCornersLayer * _Nonnull cornersLayer SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.cornersLayer' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, copy) void (^ _Nullable tapHandler)(CGPoint) SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.tapHandler' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, copy) void (^ _Nullable barcodesHandler)(NSArray<AVMetadataMachineReadableCodeObject *> * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.barcodesHandler' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) BOOL isCrazyMode SWIFT_DEPRECATED_OBJC("Swift property 'RSCodeReaderViewController.isCrazyMode' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (BOOL)hasFlash SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'RSCodeReaderViewController.hasFlash()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (BOOL)hasTorch SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'RSCodeReaderViewController.hasTorch()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (AVCaptureDevicePosition)switchCamera SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'RSCodeReaderViewController.switchCamera()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (BOOL)toggleTorch SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'RSCodeReaderViewController.toggleTorch()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
SWIFT_CLASS("_TtC16iosExperienceSDK26ESBarcodeScannerController")
@interface ESBarcodeScannerController : RSCodeReaderViewController
@property (nonatomic, copy) void (^ _Nullable completeHandler)(NSSet<NSString *> * _Nonnull) SWIFT_DEPRECATED_OBJC("Swift property 'ESBarcodeScannerController.completeHandler' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)viewDidLoad;
...
typedef SWIFT_ENUM(NSInteger, ESCustomStyleKeys, closed) {
...
typedef SWIFT_ENUM(NSInteger, ESExternalTicketSystem, closed) {
...
- (NSString * _Nonnull)getPath SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initFromTicketSystemSDK:(BOOL)fromTicketSystemSDK SWIFT_UNAVAILABLE SWIFT_DEPRECATED_OBJC("Swift initializer 'ESPassOneHandshakeRequest.init(fromTicketSystemSDK:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
...
- (NSString * _Nonnull)getPath SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initFromTicketSystemSDK:(BOOL)fromTicketSystemSDK SWIFT_UNAVAILABLE SWIFT_DEPRECATED_OBJC("Swift initializer 'ESPassOneRegistrationRequest.init(fromTicketSystemSDK:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
...
- (NSString * _Nonnull)getPath SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initFromTicketSystemSDK:(BOOL)fromTicketSystemSDK SWIFT_UNAVAILABLE SWIFT_DEPRECATED_OBJC("Swift initializer 'ESPassRequest.init(fromTicketSystemSDK:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
...
typedef SWIFT_ENUM(NSInteger, ESPaymentProcessor, closed) {
...
- (NSString * _Nonnull)getPath SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initFromTicketSystemSDK:(BOOL)fromTicketSystemSDK SWIFT_UNAVAILABLE SWIFT_DEPRECATED_OBJC("Swift initializer 'ESPerkRequest.init(fromTicketSystemSDK:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
...
+ (void)logout;
- (void)launchExpViewFromDeepLinkWithQueryUrl:(NSURL * _Nonnull)queryUrl delegate:(id <UIApplicationDelegate> _Nonnull)delegate userInfo:(ESUserInfo * _Nullable)userInfo;
...
SWIFT_CLASS("_TtC16iosExperienceSDK11RSCodeLayer")
...
SWIFT_CLASS("_TtC16iosExperienceSDK14RSCornersLayer")
...
SWIFT_CLASS("_TtC16iosExperienceSDK16RSFocusMarkLayer")
@interface RSFocusMarkLayer : CALayer
@property (nonatomic) CGSize size SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.size' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) CGFloat sight SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.sight' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) CGColorRef _Nonnull strokeColor SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.strokeColor' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) CGFloat strokeWidth SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.strokeWidth' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) CFTimeInterval delay SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.delay' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) BOOL canDraw SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.canDraw' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic) CGPoint point SWIFT_DEPRECATED_OBJC("Swift property 'RSFocusMarkLayer.point' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)drawInContext:(CGContextRef _Nonnull)ctx;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLayer:(id _Nonnull)layer OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface UIColor (SWIFT_EXTENSION(iosExperienceSDK))
...
///
- (nonnull instancetype)initWithHex3:(uint16_t)hex3 alpha:(CGFloat)alpha SWIFT_DEPRECATED_OBJC("Swift initializer 'UIColor.init(hex3:alpha:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The shorthand four-digit hexadecimal representation of color with alpha.
/// #RGBA defines to the color #RRGGBBAA.
/// \param hex4 Four-digit hexadecimal value.
///
- (nonnull instancetype)initWithHex4:(uint16_t)hex4 SWIFT_DEPRECATED_OBJC("Swift initializer 'UIColor.init(hex4:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The six-digit hexadecimal representation of color of the form #RRGGBB.
/// \param hex6 Six-digit hexadecimal value.
///
- (nonnull instancetype)initWithHex6:(uint32_t)hex6 alpha:(CGFloat)alpha SWIFT_DEPRECATED_OBJC("Swift initializer 'UIColor.init(hex6:alpha:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The six-digit hexadecimal representation of color with alpha of the form #RRGGBBAA.
/// \param hex8 Eight-digit hexadecimal value.
///
- (nonnull instancetype)initWithHex8:(uint32_t)hex8 SWIFT_DEPRECATED_OBJC("Swift initializer 'UIColor.init(hex8:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The rgba string representation of color with alpha of the form #RRGGBBAA/#RRGGBB, throws error.
/// \param rgba String value.
///
- (nullable instancetype)initWithRgba_throws:(NSString * _Nonnull)rgba error:(NSError * _Nullable * _Nullable)error SWIFT_DEPRECATED_OBJC("Swift initializer 'UIColor.init(rgba_throws:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// The rgba string representation of color with alpha of the form #RRGGBBAA/#RRGGBB, fails to default color.
/// \param rgba String value.
///
- (nonnull instancetype)init:(NSString * _Nonnull)rgba defaultColor:(UIColor * _Nonnull)defaultColor SWIFT_DEPRECATED_OBJC("Swift initializer 'UIColor.init(_:defaultColor:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Hex string of a UIColor instance.
/// \param includeAlpha Whether the alpha should be included.
///
- (NSString * _Nonnull)hexString:(BOOL)includeAlpha SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'UIColor.hexString(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
